...
class Product < ActiveRecord::Base
  ...
  validates :title, :resume, :product_type, :logo, :subtitle, :price, :price_one_year, :price_open_source, :specifications, :section_title, :pay_pal_button, :section_paragraph_1, :section_paragraph_2, :quality_1, :quality_2, :quality_3, :quality_4, presence: { message: "You must include all the fields"}
